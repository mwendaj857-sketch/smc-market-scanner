...
for idx, meta in enumerate(instruments, 1):
    ...
    for c in candidate_sides:
        ...
        three_price = cs["price_count"] >= 3 and opposed_count <= 3
        ...
        qualifies = two_of_n or three_price
...
print("=" * 72)
print("9-STRATEGY ENGINE: 9 EQUAL STRATEGIES | 2-OF-9 CONSENSUS OR 3-PRICE-MOVEMENT FALLBACK")
print("SMC is one of nine equal strategies and is NOT mandatory. Any 2 distinct strategies from the 9 can qualify; 3 distinct price-movement methods can also qualify.")
...
print("ENTRY QUALIFICATION: >=2 distinct strategies from 9 OR >=3 distinct price-movement methods; real >=2R; no HIGH news")
...
print("Entry types: SNIPER | INTRADAY | SCALP | SWING/HOLD | ADAPTIVE PRICE-MOVEMENT | POTENTIAL | WAIT")
...
print("Potential: near-complete 9-strategy or price-movement consensus is shown as potential only. Potential is never confirmed.")
